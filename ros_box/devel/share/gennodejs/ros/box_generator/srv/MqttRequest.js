...
class MqttRequestRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MqttRequestRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MqttRequestRequest
    let len;
    let data = new MqttRequestRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MqttRequestRequest(null);
    return resolved;
    }
};
...
class MqttRequestResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MqttRequestResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MqttRequestResponse
    let len;
    let data = new MqttRequestResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MqttRequestResponse(null);
...
module.exports = {
  Request: MqttRequestRequest,
  Response: MqttRequestResponse,
  md5sum() { return 'eca67f62be2b35d15d597743c12e190f'; },
  datatype() { return 'box_generator/MqttRequest'; }
};
